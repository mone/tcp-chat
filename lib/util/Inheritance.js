...
define([], function(){
	...
	var Inheritance = {
		 ...
		 *
		 * @throws {Error} if checkAliases is true and an alias of the super class
					...
					if (name) {
						...
						if (subClass.prototype[name] && subClass.prototype[name] !== subClass.prototype[i]) {
							...
							if (superClass.prototype[name] !== superClass.prototype[name]) {
								throw new Error("Can't solve alias collision, try to minify the classes again (" + name + ", " + i + ")");
							}
						}
